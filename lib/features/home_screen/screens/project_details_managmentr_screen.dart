...
class ProjectDetailsManagmentScreen extends StatefulWidget {
  ...
  String? projectId;
  ProjectDetailsManagmentScreen({Key? key, this.projectId}) : super(key: key);

  @override
  State<ProjectDetailsManagmentScreen> createState() =>
      _ProjectDetailsManagmentScreenState();
}

class _ProjectDetailsManagmentScreenState
    extends State<ProjectDetailsManagmentScreen> {
