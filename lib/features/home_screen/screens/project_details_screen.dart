...
class _ProjectDetailsScreenState extends State<ProjectDetailsScreen> {
  ...
  void initState() {
    ProjectDbService()
        .getProjectById(widget.projectId.toString())
        .then((value) {
      project = value;
      setState(() {
        loading = false;
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
          drawer: (inProject == false) ? const Drawer() : Container(),
          appBar: AppBar(
                  ...
                  panelBuilder: (ScrollController scrollController) =>
                      Container(
                          ...
                          child:
                            ...
                            Padding(
                              padding:
                                  const EdgeInsets.fromLTRB(20, 40, 45, 10),
                              child: Column(
                                children: [
                                  const TextIcon(
                            ...
                            Container(
                              width: MediaQuery.of(context).size.width,
                              padding: const EdgeInsets.fromLTRB(20, 0, 45, 5),
                              height: 200,
